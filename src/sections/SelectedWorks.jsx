      ...
      >
        ...
        >
          ...
          <div className="flex flex-col h-[1em]">
            <h6 className="flex h-[1em] font-medium leading-[1] group-hover:translate-x-[1.2em] transition-transform duration-200 ease-out uppercase overflow-y-clip whitespace-nowrap">
              {splitText(work.name)}
            </h6>
          </div>
        </div>
